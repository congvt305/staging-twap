    ...
    function (
        ...
        return function (Shipping) {
            return Shipping.extend({
                isInitialDefaultShipping: false,
                ...
                isSamePerson: ko.observable(true),
                isDifferentPerson: ko.observable(false),
                ...
                saveInitialData: function () {
                    ...
                    if (!this.isInitialDefaultShipping) {
                        ...
                        this.isInitialDefaultShipping = true;
                    }
                },
                ...
                validateShipping: function () {
                    ...
                    if (!customer.isLoggedIn() && !$.inArray('pickup_location_code', shippingAddress['extensionAttributes'])) {
                    ...
                    if (this.isFormInline) {
                        ...
                        if (!$.inArray('pickup_location_code', shippingAddress['extensionAttributes'])) {
                ...
                showFormPopUp: function () {
                    $('#shipping-new-address-form input[name="street[0]"]').attr('placeholder', $t('Enter the street address'));
                ...
                chooseSamePersonAddressType: function () {
                    ...
                    if(shippingAddress.customerAddressId) {
                        if(customerData.addresses[shippingAddress.customerAddressId]) {
                            ...
                            let customerAddress = addressConverter.formAddressDataToQuoteAddress(address);
                            shippingAddress.city = customerAddress.city;
                            shippingAddress.street = customerAddress.street;
                            homeDeliverySelector().fillShippingAddressInfo(shippingAddress);
                        }
                    }
                ...
                /**
                 * select different person address type
                 */
                chooseDifferentPersonAddressType: function () {
                    let homeDeliveryFormElement = $('#home-delivery-co-shipping-form');
                    this.isSamePerson(false);
                    this.isDifferentPerson(true);
                    $('#address-type-2').prop('checked', true);
                    $('#checkout-step-shipping #co-shipping-form')[0].reset();
                    if(homeDeliveryFormElement.length > 0) {
                        homeDeliveryFormElement[0].reset();
                    }
                },

                getCustomerTitle: function() {
                    return $t('CHECK OUT AS A GUEST');
                },
