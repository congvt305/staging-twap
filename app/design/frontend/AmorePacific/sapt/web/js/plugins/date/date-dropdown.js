define([
    ...
    function updateTheBirthDayValue(options, $selector, selectedYear, selectedMonth, selectedDay) {
    ...
    function generateBirthdayPicker ($parent, options)
    {
        ...
        var $fieldset = $("<fieldset class='birthdayPicker'></fieldset>"),
            ...
            $birthday = $("<input class='birthDay' id='"+options.inputvalue+"' name='"+options.inputvalue+"' type='hidden'/>");
