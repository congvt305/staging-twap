...
], function ($, wrapper, _, resourceUrlManager, quote, storage, totalsService, priceUtils, errorProcessor, customerData, registry, subscriber) {
	'use strict';
				...
				ajax = storage.post(
					...
					if (result.grand_total) {
						$('<li class="item proceed-total">\n' +
							' <div class="proceed-total-content"><span class="label">Total</span><span' +
