        ...
        $.widget('mage.SwatchRenderer', widget, {
            ...
            _OnClick: function ($this, $widget) {
                var $parent = $this.parents('.' + $widget.options.classes.attributeClass),
                    ...
                    $priceBox = $widget.element.parents($widget.options.selectorProduct).next('.product-info-main-attribute')
            ...
            _UpdatePrice: function () {
                var $widget = this,
                    $product = $widget.element.parents($widget.options.selectorProduct).next('.product-info-main-attribute'),
