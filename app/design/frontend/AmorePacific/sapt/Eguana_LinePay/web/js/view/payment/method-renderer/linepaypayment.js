define(
    ...
    function ($, ko, $t, url, Component, placeOrderAction, additionalValidators, quote, customerData, redirectOnSuccessAction, setShippingInformationAction) {
        'use strict';
