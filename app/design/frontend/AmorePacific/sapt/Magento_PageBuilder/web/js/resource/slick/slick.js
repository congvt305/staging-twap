...
;(function(factory) {
    ...
    Slick.prototype.buildDots = function() {
        ...
        if (_.options.dots === true && _.slideCount > _.options.slidesToShow) {
            ...
            //slick slider add pause play button by eguana
    ...
    Slick.prototype.initDotEvents = function() {
        ...
        if (_.options.dots === true && _.slideCount > _.options.slidesToShow) {
            ...
            //slick slider add pause play button by eguana
            _.$slider.find('.slick-pause').on('click.slick', function() {
                _.$slider.find('.slick-pause').removeClass('active');

                if (!_.paused) {
                    _.slickPause();
                } else {
                    _.$slider.find('.slick-pause').addClass('active');
                    _.slickPlay();
                }
            });
        }
