        ...
        function laodMobileView(x) {
            if (x.matches) {
                ...
                $( document ).ready(function() {
                    if($('li.store-list.selected-store .inner-store .stores-map').length) {
                        htmlMapElement = $('li.store-list.selected-store .inner-store').children();
                        $('.desktop-map_container .stores-content').append(htmlMapElement);
                    }else {
