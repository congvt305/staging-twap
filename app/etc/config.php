...
return [
    ...
    'modules' => [
        ...
        'Sapt_Ajaxcart' => 1,
        'Sapt_Catalog' => 1,
        'Sapt_CatalogSearch' => 1,
        'Sapt_CommonSapt' => 1,
        'Sapt_AjaxWishlist' => 1,
        'Sapt_Customer' => 1,
        'Sapt_Design' => 1,
        'Sapt_EguanaCustomerBulletin' => 0,
        'Sapt_Event' => 0,
        'Sapt_GeoTarget' => 1,
        'Sapt_LazyLoading' => 1,
        'Sapt_Megamenu' => 1,
