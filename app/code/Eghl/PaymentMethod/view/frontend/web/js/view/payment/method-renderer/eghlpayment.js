    ...
    url) {
        ...
        return Component.extend({
            ...
            afterPlaceOrder: function () {
				...
				$.ajax({
					url: url.build('eghlapi/Index/ResponseHandler/?urlType=ordershipping&OrderNumber='+window.checkoutConfig.quoteData.entity_id),
					success: function (result) {
						var start = result.indexOf('{');
						var end = result.indexOf('}');
						var filtered_res = result.substring(start, end+1);
						
						var data = $.parseJSON(filtered_res);
