...
class AddCmsBlock10 implements DataPatchInterface
{
    /**
    ...
    {
        $cmsBlockData = [
            'title' => 'Laneige Best Product',
            'identifier' => 'laneige-best-product',
            'content' => '<style>#html-body [data-pb-style=IC7NH5G]{justify-content:flex-start;display:flex;flex-direction:column;background-position:left top;background-size:cover;background-repeat:no-repeat;background-attachment:scroll}</style><div data-content-type="row" data-appearance="contained" data-element="main"><div data-enable-parallax="0" data-parallax-speed="0.5" data-background-images="{}" data-background-type="image" data-video-loop="true" data-video-play-only-visible="true" data-video-lazy-load="true" data-video-fallback-src="" data-element="inner" data-pb-style="IC7NH5G"><div data-content-type="html" data-appearance="default" data-element="main"><div class="bestseller_content">
            <div class="container">
                <div class="cms_title">
                    <h1>新產品</h1>
                </div>
