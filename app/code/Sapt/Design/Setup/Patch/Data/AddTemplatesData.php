...
class AddTemplatesData implements DataPatchInterface
{
     ...
     */
     ...
     public function apply()
     {
          $sampleData = [
               [
                    'name' => 'tw-laneige-main-hero-banner-slider-production',
                    'preview_image' => '.template-managertwlaneigemainherobannersliderproduction657fe611c4657.jpg',
    ...
    require([\'jquery\', \'slick\', \'matchMedia\', \'domReady!\'], function($, slick, mediaCheck) {
		...
		$(\'.hero-pagebuilder-slider\').on(\'init breakpoint\', function(event, slick){
			...
			responsive: [
               ...
               [
                    'name' => 'new_arrivals_tw_laneige-prod',
                    'preview_image' => '.template-managernewarrivalstwlaneigeproduction657fe71782f87.jpg',
...
padding-left: 0!important;
  padding-right: 0!important;
               ...
               [
                    'name' => 'tw-laneige-main-bestseller-slider-production',
                    'preview_image' => '.template-managertwlaneigemainbestsellersliderproduction657fe7aced524.jpg',
              ...
              user-select: auto !important;
               ...
               [
                    'name' => 'tw-laneige-banner_hasellus-production',
                    'preview_image' => '.template-managertwlaneigebannerhasellusproduction657fe7d9a3e9a.jpg',
               ...
               [
                    'name' => 'tw-laneige-main-giftset-slider-production',
                    'preview_image' => '.template-managertwlaneigemaingiftsetsliderproduction657fe80c1e3d4.jpg',
               ...
               [
                    'name' => 'tw_laneige_recommended_categories-production',
                    'preview_image' => '.template-managertwlaneigerecommendedcategoriesproduction657fe8672f732.jpg',
...
.recommended_categories h3 {font-size: 14px;line-height: 20px;margin: 11px 0 0;}
               ...
               [
                    'name' => 'tw-laneige-main-post-production',
                    'preview_image' => '.template-managertwlaneigemainpostproduction657fe8a95e59a.jpg',
...
padding-right: 60px;
               ...
               [
                    'name' => 'tw_laneige_spa_main-production',
                    'preview_image' => '.template-managertwlaneigespamainproduction657fe941e4d57.jpg',
...
<style>
    @media(max-width: 767px){
        ...
        .home-spa .swiper-button-prev {display: none;}
               ...
               [
                    'name' => 'tw_laneige_membership_only_home-production',
                    'preview_image' => '.template-managertwlaneigemembershiponlyhomeproduction657fe9a3c0717.jpg',
    ...
    margin-top: 40px !important;
               ...
               [
                    ...
                    <div class="footer_bottom">
                      <div class="footer_links">
                        <ul>
                          ...
                          <li><a href="#" target="_blank">前往品牌網頁 <span class="icon"></span></a></li>-->
                        </ul>
                      </div>
                    ...
                    -     <li>
                          ...
                          <li>
                            <a target="_blank" href="#"><span class="mobile"></span></a>
                          </li>-->
                        </ul>
                      </div>
                    </div>
               ...
               [
                ...
                <img src="{{media url=wysiwyg/wysiwyg/20231212-_BN_720x960_.jpg}}" alt="" />
                    ...
                    <div class="content">
                        ...
                        <!-- <p class="title">​</p>
                        <p style="padding: 0 10px;color: white">1月27日至31日期間於網店購買正價產品滿$2,000​
                                即享$500折扣。</p>-->
...
.blog-menu-mobile .btn-viewmore a:hover{
               ...
               [
                    'name' => 'tw-top-banner-runner-production',
                    'preview_image' => '.template-managertwtopbannerrunnerproduction6580245f7cc17.jpg',
...
#ui-id-3 {color:#fa860b !important;}
               ...
               [
                    'name' => 'tw-laneige-new-latest-recommendations-production',
                    'preview_image' => '.template-managertwlaneigenewlatestrecommendationsproduction6580278f037f5.jpg',
               ...
               [
                    'name' => 'tw_laneize_banner_b_type-production',
                    'preview_image' => '.template-managertwlaneizebannerbtypeproduction65811f4b13f16.jpg',
               ...
               [
                    'name' => 'tw_laneize_banner_b_type_style-production',
                    'preview_image' => '.template-managertwlaneizebannerbtypestyleproduction65811f99cbefc.jpg',
                  ...
                  [
                    ...
                    <p><strong>Email</strong> <a href="#">laneige@amorepacific.com.tw</a></p>
