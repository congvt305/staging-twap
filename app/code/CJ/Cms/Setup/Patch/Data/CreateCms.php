...
class CreateCms implements DataPatchInterface, PatchVersionInterface
{
    ...
    public function apply()
    {
        ...
        if ($storeVNLNGId && $storeMYLNGId){
            $this->migrateCmsPage($storeVNLNGId, $storeMYLNGId);
            $this->migrateCmsBlock($storeVNLNGId, $storeMYLNGId);
            $this->migrateWidgets($storeVNLNGId, $storeMYLNGId);
        }
    ...
    private function migrateWidgets($storeVNLNGId, $storeMYLNGId)
    {
        ...
        if ($themeId){
            /**
             * Clone widget from VN LNG to MY LNG
             */
            $tmp = 0;
