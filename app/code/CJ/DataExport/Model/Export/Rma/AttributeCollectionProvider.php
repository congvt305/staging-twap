...
class AttributeCollectionProvider
{
    ...
    public function get(): \Magento\Framework\Data\Collection
    {
        if (count($this->collection) === 0) {
            ...
            $incrementIdAttribute->setId(RmaInterface::RMA_ID);
            $incrementIdAttribute->setBackendType('varchar');
            $incrementIdAttribute->setDefaultFrontendLabel(RmaInterface::RMA_ID);
            $incrementIdAttribute->setAttributeCode(RmaInterface::RMA_ID);
