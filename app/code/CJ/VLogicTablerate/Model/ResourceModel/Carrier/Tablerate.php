...
namespace CJ\VLogicTablerate\Model\ResourceModel\Carrier;

use Magento\Framework\Filesystem;
use CJ\VLogicTablerate\Model\ResourceModel\Carrier\Tablerate\Import;
use CJ\VLogicTablerate\Model\ResourceModel\Carrier\Tablerate\RateQuery;
use CJ\VLogicTablerate\Model\ResourceModel\Carrier\Tablerate\RateQueryFactory;
...
class Tablerate extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    /**
     * @var \CJ\VLogicTablerate\Model\ResourceModel\Carrier\Tablerate
     * @since 100.1.0
     */
    ...
    public function __construct(
        ...
        \CJ\VLogicTablerate\Model\Carrier\Tablerate        $carrierTablerate,
     ...
     * @return \CJ\VLogicTablerate\Model\ResourceModel\Carrier\Tablerate
     * @throws \Magento\Framework\Exception\LocalizedException
    ...
    public function uploadAndImport(\Magento\Framework\DataObject $object)
    {
         ...
         */
        if (empty($_FILES['groups']['tmp_name']['vlogic']['fields']['import']['value'])) {
            return $this;
        }
        $filePath = $_FILES['groups']['tmp_name']['vlogic']['fields']['import']['value'];
    ...
    {
        if ($object->getData(Config::V_LOGIC_GROUPS_CONDITION_TYPE_XML_PATH) == '1') {
            $conditionName = (string)$this->coreConfig->getValue(Config::V_LOGIC_CARRIERS_CONDITION_TYPE_XML_PATH, 'default');
        } else {
            $conditionName = $object->getData(Config::V_LOGIC_GROUPS_CONDITION_VALUE_XML_PATH);
        }
