...
namespace CJ\VLogicTablerate\Block\Adminhtml\Carrier\Tablerate;
...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    /**
     * @var \CJ\VLogicTablerate\Model\ResourceModel\Carrier\Tablerate\CollectionFactory
     */
     ...
     * @param \CJ\VLogicTablerate\Model\ResourceModel\Carrier\Tablerate\CollectionFactory $collectionFactory
     * @param \CJ\VLogicTablerate\Model\Carrier\Tablerate $tablerate
     * @param array $data
     */
    public function __construct(
        \Magento\Backend\Block\Template\Context                                     $context,
        \Magento\Backend\Helper\Data                                                $backendHelper,
        \CJ\VLogicTablerate\Model\ResourceModel\Carrier\Tablerate\CollectionFactory $collectionFactory,
        \CJ\VLogicTablerate\Model\Carrier\Tablerate                                 $tablerate,
        array                                                                       $data = []
    ){
     ...
     *
     * @return \CJ\VLogicTablerate\Block\Adminhtml\Carrier\Tablerate\Grid
     */
    protected function _prepareCollection()
    {
        /** @var $collection \CJ\VLogicTablerate\Model\ResourceModel\Carrier\Tablerate\Collection */
