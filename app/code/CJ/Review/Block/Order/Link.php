 ...
 */
namespace CJ\Review\Block\Order;
...
class Link extends \Magento\Framework\View\Element\Html\Link\Current
{
    ...
    protected function _toHtml()
    {
        ...
        if($this->getKey() == 'Shipments'){
            $shipmentOrder = $this->getOrder()->getShipmentsCollection()->getFirstItem();
            if ($shipmentOrder && $shipmentOrder->getId()) {
                $tracksCollection = $shipmentOrder->getTracksCollection();
                if(empty($tracksCollection->getSize())){
                    return '';
                }
            }
        }
