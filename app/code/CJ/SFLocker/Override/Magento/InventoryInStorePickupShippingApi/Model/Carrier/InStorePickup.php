...
namespace CJ\SFLocker\Override\Magento\InventoryInStorePickupShippingApi\Model\Carrier;
 ...
 */
class InStorePickup extends \Magento\InventoryInStorePickupShippingApi\Model\Carrier\InStorePickup
{
    ...
    {
        parent::__construct($scopeConfig, $rateErrorFactory, $logger, $rateResultFactory, $rateMethodFactory, $getShippingPrice, $requestValidator, $getCarrierTitle, $data);
