 ...
 */
namespace CJ\VLogicOrder\Override\Magento\Sales\Model\Order\Shipment\Sender;
...
class EmailSender extends \Magento\Sales\Model\Order\Shipment\Sender\EmailSender
{
    ...
    public function send(
        ...
        if($order->getStatus() != 'shipment_processing' && $this->getMYSWSStoreId() == $order->getStoreId()){
            return false;
        }
