 ...
 */
namespace CJ\NinjaVanShipping\Model\ResourceModel\Carrier;

use Magento\Framework\Filesystem;
use CJ\NinjaVanShipping\Model\ResourceModel\Carrier\Tablerate\Import;
use CJ\NinjaVanShipping\Model\ResourceModel\Carrier\Tablerate\RateQuery;
use CJ\NinjaVanShipping\Model\ResourceModel\Carrier\Tablerate\RateQueryFactory;
...
class Tablerate extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    /**
     * @var \CJ\NinjaVanShipping\Model\ResourceModel\Carrier\Tablerate
     * @since 100.1.0
     */
    ...
    public function __construct(
        ...
        \CJ\NinjaVanShipping\Model\Carrier\Tablerate $carrierTablerate,
     ...
     * @throws \Magento\Framework\Exception\LocalizedException
     * @return \CJ\NinjaVanShipping\Model\ResourceModel\Carrier\Tablerate
    ...
    public function uploadAndImport(\Magento\Framework\DataObject $object)
    {
         ...
         */
        if (empty($_FILES['groups']['tmp_name']['ninjavan']['fields']['import']['value'])) {
            return $this;
        }
        $filePath = $_FILES['groups']['tmp_name']['ninjavan']['fields']['import']['value'];
    ...
    {
        if ($object->getData('groups/ninjavan/fields/condition_name/inherit') == '1') {
            $conditionName = (string)$this->coreConfig->getValue('carriers/ninjavan/condition_name', 'default');
        } else {
            $conditionName = $object->getData('groups/ninjavan/fields/condition_name/value');
        }
