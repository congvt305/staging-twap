<?php
namespace Satp\Ajaxcart\Controller\Index;
...
use Satp\Ajaxcart\Filter\LocalizedToNormalized;
use Satp\Ajaxcart\Helper\Data;
...
use Satp\AjaxWishlist\ViewModel\AjaxWishlistStatus;
...
//            );
    ...
    private function returnResult($resultItem, $relatedAdded)
    {
        ...
        if (!$this->cart->getQuote()->getHasError()) {
            ...
            $popupBlock = $resultPage->getLayout()
                ->createBlock(\Satp\Ajaxcart\Block\Ajax::class)
                ->setTemplate('Satp_Ajaxcart::popup.phtml')
                ->setItem($resultItem);
            ...
            $wishlistBlock = $resultPage->getLayout()
                ...
                ->setTemplate('Satp_AjaxWishlist::catalog/product/list/addto/wishlist.phtml')
    ...
    /**
     * Add message from satp_ajaxcart_add_before result
     *
     * @param array $message
     * @return void
     */
