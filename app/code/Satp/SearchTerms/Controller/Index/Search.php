<?php
namespace Satp\SearchTerms\Controller\Index;

use Magento\Framework\App\Action\Context;
use Magento\Framework\App\Action\HttpGetActionInterface;
use Satp\SearchTerms\Model\ResourceModel\SearchQueryRank\CollectionFactory as SearchQueryRankCollectionFactory;
...
class Search extends \Magento\Framework\App\Action\Action implements HttpGetActionInterface
{
    ...
    public function execute()
    {
        ...
        try {
            $select->joinLeft(
                ['sub_table' => 'satp_search_query_rank'],
