    ...
    $.widget('mage.apCart', {
        ...
        getSimpleProductData: function (product) {
            ...
            var productInfo = {
                ...
                'prdprice': product.product_original_price,
                'apg_brand_code': product.product_sku.substring(0, 5),
                'discount': product.product_original_price - product.product_price_value,
                'variant': '',
                'promotion': '',
                'cate': cate,
                'catecode': '',
