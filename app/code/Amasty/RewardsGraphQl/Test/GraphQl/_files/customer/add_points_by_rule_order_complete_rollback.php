...
$addedId = $persistor->get('rewards_added_order_complete_id');
if ($addedId) {
    $repository->deleteById((int)$addedId);
}
$persistor->clear('rewards_added_order_complete_id');

$customer = $customerRepository->get('rewardspoints@amasty.com');
$customerId = $customer->getId();

$actionId = $persistor->get('rewards_rule_order_complete_id');
