...
class HighlightProduct extends AbstractResolver implements ResolverInterface
{
    /**
    ...
    public function resolve(Field $field, $context, ResolveInfo $info, array $value = null, array $args = null)
    {
        ...
        return $this->highlightManagement->getHighlightForProduct($args['productId'], $customerId, $attributes);
    }
}
