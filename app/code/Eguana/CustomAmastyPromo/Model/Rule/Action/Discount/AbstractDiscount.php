...
namespace Eguana\CustomAmastyPromo\Model\Rule\Action\Discount;

use Magento\Framework\App\RequestInterface;
use Magento\Staging\Model\VersionManager;

class AbstractDiscount extends \Magento\SalesRule\Model\Rule\Action\Discount\AbstractDiscount
{
    /**
    ...
    public function aroundCalculate(\Amasty\Promo\Model\Rule\Action\Discount\AbstractDiscount $discount,  \Closure $proceed, $rule, $item, $qty)
    {
        /** @var \Magento\SalesRule\Model\Rule\Action\Discount\Data $discountData */
        $discountData = $this->discountFactory->create();
