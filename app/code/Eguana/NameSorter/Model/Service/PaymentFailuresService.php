 ...
 * Time: 4:07 PM
 */
namespace Eguana\NameSorter\Model\Service;
...
use Magento\Sales\Model\Service\PaymentFailuresService as MagentoPaymentFailuresService ;
...
class PaymentFailuresService implements PaymentFailuresInterface
{
    ...
    public function aroundHandle(
        MagentoPaymentFailuresService $subject,
        callable $proceed,
        int $cartId,
        string $message,
    ...
    private function getCustomerName(Quote $quote): string
    {
        ...
        if (!$quote->getCustomerIsGuest()) {
            $customer = $quote->getCustomer()->getLastname() . ' ' .
