...
/**
 * Change status to cancel of multiple reservations
 *
 * Class MassCancel
 */
    ...
    public function execute()
    {
        try {
            ...
            foreach ($collection as $item) {
                $item->setStatus(UserReservation::STATUS_CANCELED);
                $item->save();
            ...
            $this->messageManager->addSuccessMessage(
                __('A total of %1 user reservation(s) have been canceled.', $collection->getSize())
            );
