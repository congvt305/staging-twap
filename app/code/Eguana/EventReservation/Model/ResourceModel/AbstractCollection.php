...
/**
 * Abstract class for event_reservation, event_reservation_counter
 * & user_reservation
        ...
        try {
            ...
            if (!empty($linkedIds)) {
                ...
                $select = $connection->select()->from([
                        'eguana_event_reservation_store' => $this->getTable($tableName)
                    ])
                    ->where('eguana_event_reservation_store.' . $linkField . ' IN (?)', $linkedIds);
