...
namespace Eguana\Redemption\Model\ResourceModel\Counter\Grid;

use Eguana\Redemption\Model\ResourceModel\Counter\Collection as CounterCollection;
...
class Collection extends CounterCollection implements SearchResultInterface
{
    ...
    public function __construct(
        ...
        $this->_counterPrefix = $counterPrefix;
        $this->_counterObject = $counterObject;
