 ...
 * Time: 3:56 PM
 */
namespace Eguana\LinePay\Helper;
...
class Data extends AbstractHelper
{
     ...
     * @return mixed
     */
    public function getSandboxModeEnabled($websiteId = null)
    {
        return $this->scopeConfig->getValue(
            self::XML_LINEPAY_SANDBOX_MODE,
     ...
     * @return mixed
     */
    public function getChannelId($websiteId = null)
    {
        return $this->scopeConfig->getValue(
            self::XML_LINEPAY_CHANNEL_ID,
            ScopeInterface::SCOPE_WEBSITES,
            $websiteId
        );
    }
    ...
    {
        return $this->scopeConfig->getValue(
            self::XML_LINEPAY_CHANNEL_SECRET,
            ScopeInterface::SCOPE_WEBSITES,
            $websiteId
        );
    }
    ...
    {
        if ($this->getSandboxModeEnabled() == 'sandbox') {
