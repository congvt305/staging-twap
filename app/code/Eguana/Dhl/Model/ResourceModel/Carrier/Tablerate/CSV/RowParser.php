...
namespace Eguana\Dhl\Model\ResourceModel\Carrier\Tablerate\CSV;

use Eguana\Dhl\Model\ResourceModel\Carrier\Tablerate\LocationDirectory;
...
class RowParser
{
    ...
    /**
     * Retrieve city code from provided row data.
     *
     * @param array $rowData
     * @param ColumnResolver $columnResolver
