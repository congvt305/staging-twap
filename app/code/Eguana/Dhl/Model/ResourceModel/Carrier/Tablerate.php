...
class Tablerate extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    /**
     * @var \Eguana\Dhl\Model\ResourceModel\Carrier\Tablerate
     * @since 100.1.0
     */
     ...
     * @param \Eguana\Dhl\Model\Carrier\Tablerate $carrierTablerate
    ...
    public function __construct(
        ...
        \Eguana\Dhl\Model\Carrier\Tablerate $carrierTablerate,
    ...
    {
        $this->_init('eguana_dhl_tablerate', 'pk');
    }
     ...
     * @throws \Magento\Framework\Exception\LocalizedException
     * @return \Eguana\Dhl\Model\ResourceModel\Carrier\Tablerate
    ...
    public function uploadAndImport(\Magento\Framework\DataObject $object)
    {
         ...
         */
        if (empty($_FILES['groups']['tmp_name']['eguanadhl']['fields']['import']['value'])) {
            return $this;
        }
        $filePath = $_FILES['groups']['tmp_name']['eguanadhl']['fields']['import']['value'];
    ...
    public function getConditionName(\Magento\Framework\DataObject $object)
    {
        if ($object->getData('groups/eguanadhl/fields/condition_name/inherit') == '1') {
            ...
            $conditionName = $object->getData('groups/eguanadhl/fields/condition_name/value');
        }
