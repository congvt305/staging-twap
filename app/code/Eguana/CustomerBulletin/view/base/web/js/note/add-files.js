...
define([
    ...
    'underscore',
    'mage/template',
    'text!Eguana_CustomerBulletin/template/quote/add-file.html',
    'text!Eguana_CustomerBulletin/template/quote/attentional-modal.html',
    'text!Eguana_CustomerBulletin/template/quote/attentional-text.html',
    'text!Eguana_CustomerBulletin/template/quote/error.html',
    'mage/translate',
    'Magento_Ui/js/modal/modal',
    'Eguana_CustomerBulletin/js/note/add-file',
    'Eguana_CustomerBulletin/js/note/delete-files'
    ...
    $.widget('mage.addFiles', {
        options: {
            ...
            errorTextMaxAmount: $t('You cannot attach more than ten files per note.'),
            errorTextMaxSize: '',
        ...
        _validateSize: function (data) {
            ...
            this.options.typeError =  {
                text: $t('The maximum allowed file size is %1 .').replace('%1', this.options.maxSizeMb) +
                    $t('MB Please select a different file.'),
                subText: false
            };
        ...
        _validateExtensions: function (data) {
            ...
            this.options.typeError =  {
                text: $t('%1')
                    ...
                    $t(' is not an allowed file type. Please select a different file.') +
                    $t('Allowed file formats:') + $t('%1').replace('%1', this.extensions.join(', ')),
                subText: false
            };
        ...
        _initModal: function () {
            var modalOptions = {
                    'type': 'popup',
                    'modalClass': 'popup-attentional-quote-error main-popup confirm',
                    'responsive': false,
                    'innerScroll': false,
            ...
            this.attentionalModal.modal($.mage.__(modalOptions));
        },
