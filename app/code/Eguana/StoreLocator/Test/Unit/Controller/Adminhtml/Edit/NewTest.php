...
use Eguana\StoreLocator\Controller\Adminhtml\Edit\NewAction;
...
class NewTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(NewAction::class, $this->object);
    }
}
