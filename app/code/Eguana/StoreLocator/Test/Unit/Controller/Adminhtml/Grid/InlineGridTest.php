...
namespace Eguana\StoreLocator\Test\Unit\Controller\Adminhtml\Grid;

use Eguana\StoreLocator\Api\StoreInfoRepositoryInterface;
use Eguana\StoreLocator\Controller\Adminhtml\Grid\InlineEdit;
...
/**
 * TestCase for InlineEdit class
 * Class InlineGridTest
 *  Eguana\StoreLocator\Test\Unit\Controller\Adminhtml
 */
class InlineGridTest extends TestCase
{
    /**
     * @var MockObject
     */
    ...
    {
        $this->assertInstanceOf(InlineEdit::class, $this->object);
    }
}
