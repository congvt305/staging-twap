...
class VideoBoard extends AbstractDb
{
    ...
    {
        return $this->metadataPool->getMetadata(VideoBoardInterface::class)->getEntityConnection();
    }
     ...
     */
    private function getVideoId(AbstractModel $object, $value, $field = null)
    {
        try {
    ...
    {
        $blockId = $this->getVideoId($object, $value, $field);
        if ($blockId) {
    ...
    public function _getLoadSelect($field, $value, $object)
    {
        try {
            ...
            if ($object->getStoreId()) {
                ...
                $select->join(
                    ['ems' => $this->getTable('eguana_video_board_store')],
    ...
    public function lookupStoreIds($id)
    {
        try {
            ...
            $select = $connection->select()
                ->from(['ems' => $this->getTable('eguana_video_board_store')], 'store_id')
                ->join(
