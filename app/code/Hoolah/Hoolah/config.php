<?php
    ...
    define('HOOLAH_CHECKOUT_URL_SANDBOX_SG',    'https://demo-js.demo-hoolah.co/?ORDER_CONTEXT_TOKEN=%s&platform=magento&version=%s');
    
    define('HOOLAH_CHECKOUT_URL_PROD_MY',       'https://my.js.secure-hoolah.co/?ORDER_CONTEXT_TOKEN=%s&platform=magento&version=%s');
    define('HOOLAH_CHECKOUT_URL_SANDBOX_MY',    'https://my.demo-js.demo-hoolah.co/?ORDER_CONTEXT_TOKEN=%s&platform=magento&version=%s');

    define('HOOLAH_CHECKOUT_URL_PROD_TH',       'https://th.js.secure-hoolah.co/?ORDER_CONTEXT_TOKEN=%s&platform=magento&version=%s');
    define('HOOLAH_CHECKOUT_URL_SANDBOX_TH',    'https://demo-js.demo-hoolah.co/?ORDER_CONTEXT_TOKEN=%s&platform=magento&version=%s');
